		...
		<tr>
			<xsl:element name="TD">
				...
				<xsl:element name="input">
					...
					<xsl:attribute name="name"><xsl:value-of select="$SellrDfndInf_pName"/></xsl:attribute>
				...
				<a>
					...
					<xsl:attribute name="onClick">Swap('<xsl:value-of select="$SellrDfndInf_pName"/>')</xsl:attribute>
		...
		<tr>
			<xsl:element name="TD">
				...
				<xsl:element name="DIV">
					<xsl:attribute name="id"><xsl:value-of select="$SellrDfndInf_pName"/></xsl:attribute>
						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="id"><xsl:value-of select="$SellrDfndInf_pName"/>_<xsl:value-of select="$LablDesc"/></xsl:attribute>
						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="id"><xsl:value-of select="$SellrDfndInf_pName"/>_<xsl:value-of select="$InfDesc"/></xsl:attribute>
									<xsl:attribute name="class">CHAR_M</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
