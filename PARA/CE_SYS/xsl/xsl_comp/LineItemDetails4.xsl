		...
		<tr>
			<xsl:element name="TD">
				...
				<a>
					...
					<xsl:attribute name="onClick">Swap('<xsl:value-of select="$LineItem1_FullName_fox"/>_<xsl:value-of select="$LineItemDetails4_name"/>')</xsl:attribute>
		...
		<tr>
			<xsl:element name="TD">
				...
				<xsl:element name="DIV">
					<xsl:attribute name="id"><xsl:value-of select="$LineItem1_FullName_fox"/>_<xsl:value-of select="$LineItemDetails4_name"/></xsl:attribute>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" align="right">
								...
								<table width="85%" border="0" cellpadding="0" cellspacing="0" align="left">
									<tr>
										...
										<xsl:element name="TD">
											...
											<xsl:element name="INPUT">
												...
												<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails4_name"/>_LineItmId</xsl:attribute>
												<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails4_name"/>_LineItmId</xsl:attribute>
										...
										<xsl:element name="TD">
											<xsl:element name="INPUT">
												<xsl:attribute name="type">text</xsl:attribute>
												<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails4_name"/>_PdctNm</xsl:attribute>
												<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails4_name"/>_PdctNm</xsl:attribute>
												<xsl:attribute name="class">CHAR_M</xsl:attribute>
												<xsl:attribute name="length">35</xsl:attribute>
												<xsl:attribute name="maxlength">35</xsl:attribute>
									...
									<tr>
										...
										<xsl:element name="TD">
											<xsl:element name="INPUT">
												<xsl:attribute name="type">text</xsl:attribute>
												<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails4_name"/>_TtlAmt</xsl:attribute>
												<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails4_name"/>_TtlAmt</xsl:attribute>
												<xsl:attribute name="class">CHAR_M</xsl:attribute>
												<xsl:attribute name="length">35</xsl:attribute>
												<xsl:attribute name="maxlength">35</xsl:attribute>
						...
						<xsl:variable name="ProductIdentifier2Choice" select="$LineItemDetails4/Doc:PdctIdr"/>
						...
						<xsl:variable name="ProductCharacteristics1Choice" select="$LineItemDetails4/Doc:PdctChrtcs"/>
						...
						<xsl:variable name="ProductCategory1Choice" select="$LineItemDetails4/Doc:PdctCtgy"/>
						...
						<xsl:variable name="Incoterms1" select="$LineItemDetails4/Doc:Incotrms"/>
						...
						<xsl:variable name="Adjustment3" select="$LineItemDetails4/Doc:Adjstmnt"/>
