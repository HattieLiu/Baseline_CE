					...
					<table width="95%" border="0" cellpadding="0" cellspacing="0" align="right">
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="input">
									...
									<xsl:attribute name="id"><xsl:value-of select="$Inco_FullName_fox"/>_Cd_check</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Inco_FullName_fox"/>_Cd_check</xsl:attribute>
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="id"><xsl:value-of select="$Inco_FullName_fox"/>_Cd</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Inco_FullName_fox"/>_Cd</xsl:attribute>
							...
							<xsl:element name="TD">
								...
								<xsl:element name="input">
									<xsl:attribute name="type">radio</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$Inco_FullName_fox"/>_BEI_check</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Inco_FullName_fox"/>_BEI_check</xsl:attribute>
									<xsl:for-each select="$Incoterms2">
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$Inco_FullName_fox"/>_Othr</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Inco_FullName_fox"/>_Othr</xsl:attribute>
									<xsl:attribute name="class">CHAR_M</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Inco_FullName_fox"/>_Lctn</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$Inco_FullName_fox"/>_Lctn</xsl:attribute>
									<xsl:attribute name="class">CHAR_M</xsl:attribute>
