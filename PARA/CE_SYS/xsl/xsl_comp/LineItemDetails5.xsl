		...
		<tr>
			<xsl:element name="TD">
				...
				<a>
					...
					<xsl:attribute name="onClick">Swap('<xsl:value-of select="$Line3_FullName_fox"/>_<xsl:value-of select="$LineItemDetails5_name"/>')</xsl:attribute>
		...
		<tr>
			<xsl:element name="TD">
				...
				<xsl:element name="DIV">
					<xsl:attribute name="id"><xsl:value-of select="$Line3_FullName_fox"/>_<xsl:value-of select="$LineItemDetails5_name"/></xsl:attribute>
					...
					<table width="95%" border="0" cellpadding="0" cellspacing="0" align="left">
						<tr >						
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails5_name"/>_LineItmId</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails5_name"/>_LineItmId</xsl:attribute>
							...
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails5_name"/>_PdctNm</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails5_name"/>_PdctNm</xsl:attribute>
									<xsl:attribute name="class">CHAR_M</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
						...
						<xsl:variable name="ProductIdentifier2Choice" select="$LineItemDetails5/Doc:PdctIdr"/>
						...
						<xsl:variable name="ProductCharacteristics1Choice" select="$LineItemDetails5/Doc:PdctChrtcs"/>
						...
						<xsl:variable name="ProductCategory1Choice" select="$LineItemDetails5/Doc:PdctCtgy"/>
						...
						<tr>																
								<xsl:element name="TD">														
								   ...
								   <xsl:element name="INPUT">							    
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails5_name"/>_OrdrdAmt</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails5_name"/>_OrdrdAmt</xsl:attribute>
									<xsl:attribute name="class">CHAR_M</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>								
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails5_name"/>_AccptdAmt</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails5_name"/>_AccptdAmt</xsl:attribute>
									<xsl:attribute name="class">CHAR_M</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
						...
						<tr>
							...
							<xsl:attribute name="align">left</xsl:attribute>
							   <xsl:attribute name="nowrap">true</xsl:attribute>
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails5_name"/>_OutsdngAmt</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails5_name"/>_OutsdngAmt</xsl:attribute>
									<xsl:attribute name="class">CHAR_M</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
							...
							<xsl:attribute name="nowrap">true</xsl:attribute>
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails5_name"/>_PdgAmt</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails5_name"/>_PdgAmt</xsl:attribute>
									<xsl:attribute name="class">CHAR_M</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
