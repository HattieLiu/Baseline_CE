						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="input">
									...
									<xsl:attribute name="id"><xsl:value-of select="$Char2_FullName_fox"/>_Tp_check</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Char2_FullName_fox"/>_Tp_check</xsl:attribute>
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="id"><xsl:value-of select="$Char2_FullName_fox"/>_Tp</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Char2_FullName_fox"/>_Tp</xsl:attribute>
							...
							<xsl:element name="TD">
								...
								<xsl:element name="input">
									<xsl:attribute name="type">radio</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$Char2_FullName_fox"/>_OthrChrgsTp_check</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Char2_FullName_fox"/>_OthrChrgsTp_check</xsl:attribute>
									<xsl:for-each select="$ChargesDetails2">
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$Char2_FullName_fox"/>_OthrChrgsTp</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Char2_FullName_fox"/>_OthrChrgsTp</xsl:attribute>
									<xsl:attribute name="class">CHAR_M</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
