...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:Doc="urn:com.cs.tsu">
	...
	<xsl:template match="Doc:Document/Doc:tsmt.008.001.02">
	    <xsl:param name="stmt" select="Doc:tsmt.008.001.02"/>
		<html>
			<head>
				...
				<table width="99%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<xsl:element name="TD">
							...
							<xsl:text>AmendmentRejectionNotification: (tsmt.008.001.02)</xsl:text>
						</xsl:element>
					</tr>
					<tr>
						<xsl:element name="TD">
					...
					<tr>
						...
						<td colspan="10">
							<table width="99%" border="0" cellpadding="0" cellspacing="0">
								...
								<!-- RjctdAmdmntNb -->
								<xsl:variable name="Count1" select="Doc:RjctdAmdmntNb"/>
