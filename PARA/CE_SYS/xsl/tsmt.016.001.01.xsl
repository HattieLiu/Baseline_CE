...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:Doc="urn:com.cs.tsu">
	...
	<xsl:template match="Doc:Document/Doc:tsmt.016.001.01">
		<html>
			<head>
				...
				<table width="99%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<xsl:element name="TD">
							...
							<xsl:text>ErrorReport : Structure and Contents(tsmt.016.001.01)</xsl:text>
						</xsl:element>
					</tr>
					<tr>
						<xsl:element name="TD">
					...
					<tr>
						...
						<td colspan="10">
							<table width="99%" border="0" cellpadding="0" cellspacing="0">
								...
								<!-- ErrDesc -->
								<xsl:variable name="ValidationResult1" select="Doc:ErrDesc"/>
								<xsl:call-template name="ValidationResult1">
									<xsl:with-param name="ValidationResult1" select="$ValidationResult1"/>
								</xsl:call-template>
								<!-- ReqForActn -->
