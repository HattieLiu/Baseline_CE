...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="ProductCategory1">
		...
		<xsl:variable name="CtgyDesc">
			<xsl:call-template name="getFldDesc1">
				<xsl:with-param name="FldId" select="'Ctgy'"/>
			</xsl:call-template>
		</xsl:variable>
						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="value"><xsl:value-of select="$ProductCategory1/Tp"/></xsl:attribute>
								</xsl:element>
							</xsl:element>
							<xsl:element name="TD">
								<xsl:attribute name="style">width:30%;FONT-FAMILY: Verdana, Arial;FONT-SIZE: 11px;</xsl:attribute>
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="value"><xsl:value-of select="$ProductCategory1/Ctgy"/></xsl:attribute>
								</xsl:element>
							</xsl:element>
						</tr>
					</table>
