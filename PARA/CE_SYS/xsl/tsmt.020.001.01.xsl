...
<xsl:include href="public.xsl"/>
	<xsl:include href="Components/ElementIdentification2.xsl"/> 
...
<xsl:include href="Components/DocumentIdentification5.xsl"/>
	<xsl:template match="Doc:Document/Doc:tsmt.020.001.01">
		<html>
			<head>
				...
				<table width="99%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<xsl:element name="TD">
							...
							<xsl:text>MisMatchAcceptance: (tsmt.020.001.01)</xsl:text>
						</xsl:element>
					</tr>
					<tr>
						<xsl:element name="TD">
