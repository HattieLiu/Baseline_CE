...
<xsl:include href="Components/TransactionStatus3.xsl"/>
	<xsl:template match="Doc:Document/Doc:tsmt.027.001.01">
		<html>
			<head>
				...
				<table width="99%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<xsl:element name="TD">
							...
							<xsl:text>StatusChangeRequestAcceptance: (tsmt.027.001.01)</xsl:text>
						</xsl:element>
					</tr>
					<tr>
						<xsl:element name="TD">
					...
					<tr>
						...
						<td colspan="10">
							<table width="99%" border="0" cellpadding="0" cellspacing="0">
								...
								<!-- AccptdSts -->
								<xsl:variable name="TransactionStatus3" select="Doc:AccptdSts"/>
