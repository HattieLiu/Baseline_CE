...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:Doc="urn:com.cs.tsu">
	...
	<xsl:template name="LineItemDetails6">
		...
		<xsl:param name="LineItemDetails6_parent"/>
		<xsl:param name="Line2_FullName"/>
		<xsl:variable name="LineItemDetails6_name" select="name($LineItemDetails6)"/>
		<xsl:variable name="LineItemDetails6_pname" select="$LineItemDetails6_parent"/>
		...
		<tr>
			<xsl:element name="TD">
				...
				<a>
					...
					<xsl:attribute name="onClick">Swap('<xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_<xsl:value-of select="$refrain"/>')</xsl:attribute>
		...
		<tr>
			<xsl:element name="TD">
				...
				<xsl:element name="DIV">
					<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_<xsl:value-of select="$refrain"/></xsl:attribute>
					...
					<table width="95%" border="0" cellpadding="0" cellspacing="0" align="right">
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_LineItmId</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_LineItmId</xsl:attribute>
						...
						<xsl:call-template name="Quantity2">
							...
							<xsl:with-param name="Quantity2_parent">
								<xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_<xsl:value-of select="$refrain"/>
							</xsl:with-param>
						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_PdctNm</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_PdctNm</xsl:attribute>
									<xsl:attribute name="class">CHAR_P</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
						...
						<xsl:for-each select="$LineItemDetails6/Doc:PdctIdr">
						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_PdctOrgn</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_PdctOrgn</xsl:attribute>
									<xsl:attribute name="class">CHAR_P</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_TtlAmt</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$LineItemDetails6_pname"/>_<xsl:value-of select="$LineItemDetails6_name"/>_TtlAmt</xsl:attribute>
									<xsl:attribute name="class">CHAR_P</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
