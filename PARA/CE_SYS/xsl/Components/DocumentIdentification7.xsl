		...
		<tr>
			<xsl:element name="TD">
				...
				<a>
					...
					<xsl:attribute name="onClick">Swap('<xsl:value-of select="$DocumentIdentification7_pname"/>_<xsl:value-of select="$Docu7_FullName_Fox"/>_<xsl:value-of select="$DocumentIdentification7_name"/>')</xsl:attribute>
		...
		<tr>
			<xsl:element name="TD">
				...
				<xsl:element name="DIV">
					<xsl:attribute name="id"><xsl:value-of select="$DocumentIdentification7_pname"/>_<xsl:value-of select="$Docu7_FullName_Fox"/>_<xsl:value-of select="$DocumentIdentification7_name"/></xsl:attribute>
						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="name"><xsl:value-of select="$DocumentIdentification7_pname"/>_<xsl:value-of select="$Docu7_FullName_Fox"/>_Id</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$DocumentIdentification7_pname"/>_<xsl:value-of select="$Docu7_FullName_Fox"/>_Id</xsl:attribute>
							...
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									<xsl:attribute name="type">text</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$DocumentIdentification7_pname"/>_<xsl:value-of select="$Docu7_FullName_Fox"/>_DtOfIsse</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$DocumentIdentification7_pname"/>_<xsl:value-of select="$Docu7_FullName_Fox"/>_DtOfIsse</xsl:attribute>
									<xsl:attribute name="class">W_DT</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
