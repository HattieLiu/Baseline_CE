					...
					<table width="85%" border="0" cellpadding="0" cellspacing="0" align="left">
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="input">
									...
									<xsl:attribute name="id"><xsl:value-of select="$Tax13_pname"/>_<xsl:value-of select="$Tax13_name"/>_Tp_check</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Tax13_pname"/>_<xsl:value-of select="$Tax13_name"/>_Tp_check</xsl:attribute>									
							...
							<xsl:element name="TD">
								...
								<xsl:element name="input">
									<xsl:attribute name="type">radio</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$Tax13_pname"/>_<xsl:value-of select="$Tax13_name"/>_OthrAdjstmntTp_check</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Tax13_pname"/>_<xsl:value-of select="$Tax13_name"/>_OthrAdjstmntTp_check</xsl:attribute>
									<xsl:for-each select="$Tax13">
						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="input">
									<xsl:attribute name="type">radio</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$Tax13_pname"/>_<xsl:value-of select="$Tax13_name"/>_Amt_check</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Tax13_pname"/>_<xsl:value-of select="$Tax13_name"/>_Amt_check</xsl:attribute>							    
										<xsl:for-each select="$Tax13">
										<xsl:if test="Doc:Amt != ''">
											<xsl:attribute name="checked">true</xsl:attribute>
										</xsl:if>
							...
							<xsl:element name="TD">
								...
								<xsl:element name="input">
									<xsl:attribute name="type">radio</xsl:attribute>
									<xsl:attribute name="id"><xsl:value-of select="$Tax13_pname"/>_<xsl:value-of select="$Tax13_name"/>_Rate_check</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$Tax13_pname"/>_<xsl:value-of select="$Tax13_name"/>_Rate_check</xsl:attribute>								
									 <xsl:for-each select="$Tax13">
