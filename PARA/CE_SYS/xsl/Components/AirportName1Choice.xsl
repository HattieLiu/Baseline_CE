		...
		<tr>
			<xsl:element name="TD">
				...
				<a>
					...
					<xsl:attribute name="onClick">Swap('<xsl:value-of select="$AirportName1Choice_pname"/>_<xsl:value-of select="$AirportName1_FullName_fox"/>_<xsl:value-of select="$AirportName1Choice_name"/>')</xsl:attribute>
		...
		<tr>
			<xsl:element name="TD">
				...
				<xsl:element name="DIV">
					...
					<xsl:attribute name="id"><xsl:value-of select="$AirportName1Choice_pname"/>_<xsl:value-of select="$AirportName1_FullName_fox"/>_<xsl:value-of select="$AirportName1Choice_name"/></xsl:attribute>
						...
						<tr>
							<xsl:element name="TD">
								...
								<xsl:element name="input">
									...
									<xsl:attribute name="id"><xsl:value-of select="$AirportName1Choice_pname"/>_<xsl:value-of select="$AirportName1_FullName_fox"/>_<xsl:value-of select="$AirportName1Choice_name"/>_AirprtCd_check</xsl:attribute>
									<xsl:attribute name="name"><xsl:value-of select="$AirportName1Choice_pname"/>_<xsl:value-of select="$AirportName1_FullName_fox"/>_<xsl:value-of select="$AirportName1Choice_name"/>_AirprtCd_check</xsl:attribute>
						...
						<tr>
							<xsl:element name="TD">
								...
								<a>
									...
									<xsl:attribute name="onClick">Swap('<xsl:value-of select="$AirportName1Choice_pname"/>_<xsl:value-of select="$AirportName1_FullName_fox"/>_<xsl:value-of select="$AirportName1Choice_name"/>_<xsl:value-of select="$OthrAirprtDesc"/>')</xsl:attribute>
						...
						<tr>
						 <xsl:element name="TD">
						    <xsl:element name="DIV">
									...
									<xsl:attribute name="id"><xsl:value-of select="$AirportName1Choice_pname"/>_<xsl:value-of select="$AirportName1_FullName_fox"/>_<xsl:value-of select="$AirportName1Choice_name"/>_<xsl:value-of select="$OthrAirprtDesc"/></xsl:attribute>
									<xsl:attribute name="style">DISPLAY:none;overflow: hidden; border: 0px none #000000;width:95%;</xsl:attribute>
