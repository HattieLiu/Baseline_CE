...
<!--  *********** point <LineItem6> Start ********** -->
	<xsl:template name="LineItem6">
		...
		<xsl:param name="stmt" select="'Doc:RptdLineItm'"/>
			...
			<xsl:element name="TD">
				...
				<xsl:element name="DIV">
					...
					<table width="95%" border="0" cellpadding="0" cellspacing="0" align="right">
						<tr>
						<xsl:for-each select="$LineItem6/Doc:LineItmDtls">
						<xsl:variable name="LineItemDetails5" select="."/>
						<xsl:call-template name="LineItemDetails5">
							...
							<xsl:with-param name="LineItemDetails5_parent">
