		...
		<tr>
			<xsl:element name="TD">
				...
				<a>
					...
					<xsl:attribute name="onClick">Swap('<xsl:value-of select="$PostalAddress2_pname"/>_<xsl:value-of select="$Post_FullName_fox"/>_<xsl:value-of select="$PostalAddress2_name"/>')</xsl:attribute>
		...
		<tr>
			<xsl:element name="TD">
				...
				<xsl:element name="DIV">
					<xsl:attribute name="id"><xsl:value-of select="$PostalAddress2_pname"/>_<xsl:value-of select="$Post_FullName_fox"/>_<xsl:value-of select="$PostalAddress2_name"/></xsl:attribute>
						...
						<tr>
							...
							<xsl:element name="TD">
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="class">W_16</xsl:attribute>
									<xsl:attribute name="length">35</xsl:attribute>
									<xsl:attribute name="maxlength">35</xsl:attribute>
