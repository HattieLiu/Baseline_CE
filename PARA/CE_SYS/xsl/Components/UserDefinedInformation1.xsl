		...
		<tr>
			<xsl:element name="TD">
				...
				<a>
					...
					<xsl:attribute name="onClick">Swap('<xsl:value-of select="$UserDefinedInformation1_pname"/>_<xsl:value-of select="$User_FullName_fox"/>_<xsl:value-of select="$UserDefinedInformation1_name"/>')</xsl:attribute>
		...
		<tr>
			<xsl:element name="TD">
				...
				<xsl:element name="DIV">
					<xsl:attribute name="id"><xsl:value-of select="$UserDefinedInformation1_pname"/>_<xsl:value-of select="$User_FullName_fox"/>_<xsl:value-of select="$UserDefinedInformation1_name"/></xsl:attribute>
						...
						<tr>
							...
							<xsl:element name="TD">
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="class">W_140</xsl:attribute>
